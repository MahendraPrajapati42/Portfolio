...
router.post('/transaction', auth,async(req, res) => {
    ...
    let trade = req.body.tradeType
    let price = req.body.unitPrice
    let date = req.body.TradeDate
    date = date.split('-')
    ...
    console.log(`${date[2]} ${months[date[1]]} ${date[0]}`);
    let date1 = new Date(`${date[2] } ${months[date[1]]} ${date[0]}`)
